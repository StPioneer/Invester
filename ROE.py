# -*- coding: utf-8 -*-
"""
Created on Sun Nov 11 17:47:44 2018
...
TWII = TWII(report.index.min().year,report.index.max().year)

plt.plot(TWII)
plt.plot(np.hstack((1,reportMediam)))
plt.show()
print("年化報酬 : " ,round((10**(math.log(((reportYA[:,5,5]/100)+1).cumprod()[-1],10)/17) -1)*100,2))
print("年均報酬" , round((reportYA[:,5,5]/100).mean()*100,2))